<div class="jumbotron bg-white text-center">
  <h1 class="display-4">Equipe 2: PHP com banco de dados</h1>
  <p class="lead">Projeto: Protótipo de sistema de cadastro de alunos (cadastro, listagem, edição e deleção).</p>
  <hr class="my-4 w-50">
